      ...
      <aside className="w-64 bg-sidebar border-r border-border flex flex-col justify-between p-5 shrink-0 transition-all shadow-tactical-card z-20">
        <div className="space-y-6">
          ...
          <div className="flex items-center space-x-3 px-1 py-1">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-blue-600 via-indigo-600 to-neon-cyan flex items-center justify-center text-white shadow-glow-cyan shrink-0">
              <svg className="w-4.5 h-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
              </svg>
            </div>
            <div>
              <div className="text-sm font-black tracking-wider text-foreground font-poppins">
                AGENTIC DEFENSE
              </div>
